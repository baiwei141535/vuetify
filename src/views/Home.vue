    ...
    <v-layout row>
      <v-flex md3>
        <v-app :style="{background: $vuetify.theme.themes.light.background}">
          <v-container>
            <v-flex>
              <v-card class="ma-5 text-center mt-8" shaped elevation="10">
                ...
                <v-card-subtitle calss="layout justofy-center">24 year, California</v-card-subtitle>

                <v-list class="mt-n5">
                  <v-list-item>
                    <v-list-item-title class="cyan--text text--dark-1">Blood</v-list-item-title>
                    <v-list-item-title class="cyan--text text--dark-1">Height</v-list-item-title>
                    <v-list-item-title class="cyan--text text--dark-1">Weight</v-list-item-title>
                  </v-list-item>
                  <v-list-item class="mt-n5">
                    <v-list-item-subtitle>-B</v-list-item-subtitle>
                    <v-list-item-subtitle>172 CM</v-list-item-subtitle>
          ...
          <v-flex>
            <v-card class="ma-5 mt-n2" shaped elevation="10">
              <v-list>
                ...
                <v-list-item>
                  <v-list-item-title class="cyan--text text--dark-1">MON</v-list-item-title>
                  <v-list-item-title class="cyan--text text--dark-1">WED</v-list-item-title>
                  <v-list-item-title class="cyan--text text--dark-1">FRI</v-list-item-title>
                  <v-list-item-title class="cyan--text text--dark-1">SUN</v-list-item-title>
                </v-list-item>
                <v-list-item class="mt-n5">
              ...
              <v-list two-line="" subheader="">
                <v-list-item>
                  ...
                  <v-list-item-content class="ml-10">
                    ...
                    <v-list-item-subtitle>Cailfornia Hospital Medical</v-list-item-subtitle>
                  </v-list-item-content>
                </v-list-item>
              </v-list>
              <v-list two-line="" subheader="" class="mt-n5">
                <v-list-item>
                    <v-list-item-title>Surgeno</v-list-item-title>
          ...
          <v-flex>
            <v-card class="ma-5 text-center mt-15" shaped="  " elevation="10">
              <v-list-item three-line="">
                <v-list-item-content>
                  <v-list-item-title class="headline mb-1">
                    <v-icon>fab fa-cc-visa</v-icon>
                  </v-list-item-title>
                  <v-list-item-subtitle>5478 6985 3265 1452</v-list-item-subtitle>
                </v-list-item-content>
