<template>
    <nav>
        <v-navigation-drawer v-model="drawer" dark app mini-variant mini-variant-width="100" class="cyan darkne-1"> 
            <v-list>
            ...
            <v-list flat>
                ...
                <v-list-item router to ="/">
                    <v-list-item-content>
                        ...
                        <v-list-item-subtitle align ="center">Doctors</v-list-item-subtitle>
                    </v-list-item-content>
                </v-list-item>
                <v-list-item router to ="/">
                    <v-list-item-content>
                        <v-icon class="mb-2">fas fa-user-md</v-icon>
                        <v-list-item-subtitle align ="center">contract</v-list-item-subtitle>
                    </v-list-item-content>
                </v-list-item>
                <v-list-item router to ="/">
                    <v-list-item-content>
